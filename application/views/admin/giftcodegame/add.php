                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                             ...
                                                             onclick="window.location.href = '<?php echo base_url('giftcodegame/add') ?>'; ">
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $("#search_tran").click(function () {
        if ($("#numberrotate").val() == "") {
            ...
            $("#errorgift").html("Bạn phải nhập nguồn giftcode");
            return false;
        }
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('superajax/add') ?>",
            data: {
